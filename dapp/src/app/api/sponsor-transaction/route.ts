    ...
    if (action === 'create') {
      ...
      const sponsoredTx = await enoki.createSponsoredTransaction({
        ...
        allowedMoveCallTargets: [
          `${process.env.NEXT_PUBLIC_PACKAGE_ID}::nft_marketplace::mint_to_sender`,
          `${process.env.NEXT_PUBLIC_PACKAGE_ID}::nft_marketplace::list_for_sale`,
          `${process.env.NEXT_PUBLIC_PACKAGE_ID}::nft_marketplace::purchase_nft`,
          `${process.env.NEXT_PUBLIC_PACKAGE_ID}::nft_marketplace::remove_listing`,
        ],
